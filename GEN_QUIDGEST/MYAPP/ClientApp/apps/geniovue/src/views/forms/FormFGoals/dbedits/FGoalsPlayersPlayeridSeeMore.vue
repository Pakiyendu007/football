<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-goals-players-playerid-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_GOALS__PLAYERS__PLAYERID_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FGoalsPlayersPlayeridSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_GOALS__PLAYERS__PLAYERID_SeeMore', false),

				interfaceMetadata: {
					id: 'F_GOALS__PLAYERS__PLAYERID_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_GOALS__PLAYERS__PLAYERID_SeeMore',
					name: 'F_GOALS__PLAYERS__PLAYERID_SeeMore',
					controller: 'GOALS',
					action: 'F_GOALS_PlayersValPlayerid'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-goals-players-playerid',
				dismissAction: this.close,
				returnElement: 'F_GOALS__PLAYERS__PLAYERID_see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.PLAYERS01799),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-goals-players-playerid')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'F_goals_PlayersValPlayerid',
							serverMode: true,
						...
						uuid: 'F_goals_F_goals_PlayersValPlayerid',
