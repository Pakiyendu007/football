<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-goals-matches-matchid-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_GOALS__MATCHES__MATCHID_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FGoalsMatchesMatchidSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_GOALS__MATCHES__MATCHID_SeeMore', false),

				interfaceMetadata: {
					id: 'F_GOALS__MATCHES__MATCHID_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_GOALS__MATCHES__MATCHID_SeeMore',
					name: 'F_GOALS__MATCHES__MATCHID_SeeMore',
					controller: 'GOALS',
					action: 'F_GOALS_MatchesValMatchid'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-goals-matches-matchid',
				dismissAction: this.close,
				returnElement: 'F_GOALS__MATCHES__MATCHID_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-goals-matches-matchid')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'F_goals_MatchesValMatchid',
							serverMode: true,
						...
						uuid: 'F_goals_F_goals_MatchesValMatchid',
