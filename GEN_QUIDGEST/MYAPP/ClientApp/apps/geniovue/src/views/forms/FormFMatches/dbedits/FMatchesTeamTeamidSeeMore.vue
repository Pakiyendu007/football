<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-matches-team-teamid-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_MATCHES__TEAM__TEAMID_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FMatchesTeamTeamidSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_MATCHES__TEAM__TEAMID_SeeMore', false),

				interfaceMetadata: {
					id: 'F_MATCHES__TEAM__TEAMID_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_MATCHES__TEAM__TEAMID_SeeMore',
					name: 'F_MATCHES__TEAM__TEAMID_SeeMore',
					controller: 'MATCHES',
					action: 'F_MATCHES_TeamValTeamid'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-matches-team-teamid',
				dismissAction: this.close,
				returnElement: 'F_MATCHES__TEAM__TEAMID_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-matches-team-teamid')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-TEAM'],
						uuid: 'F_matches_F_matches_TeamValTeamid',
