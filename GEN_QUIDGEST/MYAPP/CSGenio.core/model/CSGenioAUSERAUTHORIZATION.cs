...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("PNL", "userauthorization", "userauthorization", "codua", "codpsw", "PNL", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL PNL TABAUX UserAuthorization]/
