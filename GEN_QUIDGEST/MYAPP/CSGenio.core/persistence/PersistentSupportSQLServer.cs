    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("PNLMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("PNLMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("PNLMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("PNLMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("PNLMQQueues_History", "ANO", "ANO")
                            .Select("PNLMQQueues_History", "USERNAME", "USERNAME")
                            .Select("PNLMQQueues_History", "TABELA", "TABELA")
                            .Select("PNLMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("PNLMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("PNLMQQueues_History", "QUEUE", "QUEUE")
                            .Select("PNLMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("PNLMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("PNLMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("PNLMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("PNLMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("PNLMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("PNLMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("PNLMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("PNLMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.PNLMQQueues_History";
