...
namespace GenioMVC.Controllers
{
	public partial class RefereesController : ControllerBase
	{
		...
		public RefereesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PNL CONTROLLER_NAVIGATION REFEREES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAreferees>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL PNL MANUAL_CONTROLLER REFEREES]/
		...
		/// <summary>
		/// Recalculate formulas of the "F_referees" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_F_referees([FromBody]F_referees_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "referees",
				(primaryKey) => Models.Referees.Find(primaryKey, UserContext.Current, "FF_REFEREES"),
				(model) => formData.MapToModel(model as Models.Referees)
			);
		}
		...
		{
			return base.GetDocumsTickets("REFEREES", requestModel.FieldName, requestModel.KeyValue);
		}
