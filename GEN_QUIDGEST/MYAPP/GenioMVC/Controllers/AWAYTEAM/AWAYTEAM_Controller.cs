...
namespace GenioMVC.Controllers
{
	public partial class AwayteamController : ControllerBase
	{
		...
		public AwayteamController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PNL CONTROLLER_NAVIGATION AWAYTEAM]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAawayteam>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL PNL MANUAL_CONTROLLER AWAYTEAM]/
		...
		{
			return base.GetDocumsTickets("AWAYTEAM", requestModel.FieldName, requestModel.KeyValue);
		}
