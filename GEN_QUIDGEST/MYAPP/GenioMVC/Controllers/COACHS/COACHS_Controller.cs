...
// USE /[MANUAL PNL INCLUDE_CONTROLLER COACHS]/

namespace GenioMVC.Controllers
{
	public partial class CoachsController : ControllerBase
	{
		private IChatbotService _aiService;
		public CoachsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PNL CONTROLLER_NAVIGATION COACHS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcoachs>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL PNL MANUAL_CONTROLLER COACHS]/
		...
		{
			return base.GetDocumsTickets("COACHS", requestModel.FieldName, requestModel.KeyValue);
		}
