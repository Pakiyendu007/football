...
// USE /[MANUAL PNL INCLUDE_CONTROLLER STADIUMS]/

namespace GenioMVC.Controllers
{
	public partial class StadiumsController : ControllerBase
	{
		private IChatbotService _aiService;
		public StadiumsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PNL CONTROLLER_NAVIGATION STADIUMS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAstadiums>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL PNL MANUAL_CONTROLLER STADIUMS]/
		...
		{
			return base.GetDocumsTickets("STADIUMS", requestModel.FieldName, requestModel.KeyValue);
		}
