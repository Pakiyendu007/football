...
public class F_players_MatchesValMatchid_RowViewModel : Models.Matches
{
	#region Constructors

	public F_players_MatchesValMatchid_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_players_MatchesValMatchid_RowViewModel(UserContext userContext, CSGenioAmatches val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
