...
public class PNL_Menu_131_RowViewModel : Models.Players
{
	#region Constructors

	public PNL_Menu_131_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PNL_Menu_131_RowViewModel(UserContext userContext, CSGenioAplayers val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
