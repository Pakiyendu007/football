...
public class F_goals_PlayersValPlayerid_RowViewModel : Models.Players
{
	#region Constructors

	public F_goals_PlayersValPlayerid_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_goals_PlayersValPlayerid_RowViewModel(UserContext userContext, CSGenioAplayers val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
