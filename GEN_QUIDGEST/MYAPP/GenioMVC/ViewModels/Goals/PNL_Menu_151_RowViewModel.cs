...
public class PNL_Menu_151_RowViewModel : Models.Goals
{
	#region Constructors

	public PNL_Menu_151_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PNL_Menu_151_RowViewModel(UserContext userContext, CSGenioAgoals val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
