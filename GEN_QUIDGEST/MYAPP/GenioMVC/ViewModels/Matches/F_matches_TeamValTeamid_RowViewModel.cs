...
public class F_matches_TeamValTeamid_RowViewModel : Models.Team
{
	#region Constructors

	public F_matches_TeamValTeamid_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_matches_TeamValTeamid_RowViewModel(UserContext userContext, CSGenioAteam val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
