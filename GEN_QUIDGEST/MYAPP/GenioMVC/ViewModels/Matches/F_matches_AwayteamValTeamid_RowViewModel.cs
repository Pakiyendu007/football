...
public class F_matches_AwayteamValTeamid_RowViewModel : Models.Awayteam
{
	#region Constructors

	public F_matches_AwayteamValTeamid_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_matches_AwayteamValTeamid_RowViewModel(UserContext userContext, CSGenioAawayteam val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
