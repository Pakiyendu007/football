...
public class PNL_Menu_121_RowViewModel : Models.Matches
{
	#region Constructors

	public PNL_Menu_121_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PNL_Menu_121_RowViewModel(UserContext userContext, CSGenioAmatches val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
