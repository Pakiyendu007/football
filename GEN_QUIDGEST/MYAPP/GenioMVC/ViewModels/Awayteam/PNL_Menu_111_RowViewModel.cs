...
public class PNL_Menu_111_RowViewModel : Models.Awayteam
{
	#region Constructors

	public PNL_Menu_111_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PNL_Menu_111_RowViewModel(UserContext userContext, CSGenioAawayteam val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
