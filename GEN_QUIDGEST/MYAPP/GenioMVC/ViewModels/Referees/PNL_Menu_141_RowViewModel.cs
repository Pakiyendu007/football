...
public class PNL_Menu_141_RowViewModel : Models.Referees
{
	#region Constructors

	public PNL_Menu_141_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PNL_Menu_141_RowViewModel(UserContext userContext, CSGenioAreferees val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
