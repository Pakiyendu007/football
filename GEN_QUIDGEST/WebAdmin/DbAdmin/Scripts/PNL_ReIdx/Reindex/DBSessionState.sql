...
SET @SQL = N'
CREATE DATABASE [ASPStatePNL]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStatePNL'', FILENAME = N''' + @SQLDataFolder + 'ASPStatePNL.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStatePNL_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStatePNL_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePNL_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStatePNL_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePNL_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStatePNL] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStatePNL] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
