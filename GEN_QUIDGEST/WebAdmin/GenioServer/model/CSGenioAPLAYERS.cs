...
namespace CSGenio.business
{
	...
	/// players
	/// </summary>
	public class CSGenioAplayers : DbArea
	{
		/// <summary>
		...
		public CSGenioAplayers(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL PNL CONSTRUTOR PLAYERS]/
		}

		public CSGenioAplayers(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.DescriptionCav="PLAYERS01799";
		...
		private static FieldRef m_fldZzstate = new FieldRef("players", "zzstate");
        ...
        public static CSGenioAplayers search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAplayers area = new CSGenioAplayers(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAplayers> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAplayers>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAplayers> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAplayers>(where, listing);
        }
